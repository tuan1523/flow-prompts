...
— Kiểu chụp: {standing outdoors on a sunny tree-lined street, wearing a plain white baseball cap and sunglasses, face turned away to the side in profile, a small cream shoulder bag and a takeaway coffee cup in hand, framed from the waist up with the camera close enough that the chest design stays large and clearly readable, bright neutral sunlight with soft shadows|Ngoài phố nắng + nón trắng + kính / indoor chest-up close crop — the frame cut just above her lips so only the lower face shows, long loose waves falling over one shoulder, layered thin gold necklaces, bright airy room softly blurred|Trong nhà cận ngực (thấy môi) / standing in a bright cozy room, a soft smile with the frame cropped at the nose, hands tucked behind her back, the sweatshirt front-tucked into light-wash jeans, framed from the hips up with the camera close enough that the chest design stays large and clearly readable, airy curtains and wall art softly blurred|Đứng cười nhẹ + sơ vin jeans / sitting relaxed on a bright cozy chair, one hand lifted running through her hair, soft smile with the frame cropped at the nose, framed from the waist up with the camera close enough that the chest design stays large and clearly readable, pampas grass and a small side table softly blurred|Ngồi thư giãn + vuốt tóc / extreme close-up of the chest area only — no face, no head, the embroidery filling the frame with every stitch sharply readable, gentle fabric folds|Siêu cận ngực áo (không mặt) / a person holding the garment up toward the camera by the shoulders, arms extended, the full front of the garment flat and readable, casual bright home interior softly blurred behind|Cầm áo giơ lên khoe}

CAMERA DISTANCE (critical — follow exactly, applies to every shot style):
The camera is CLOSE — about one meter away, never further. The frame covers AT MOST from the top of the head (or the lip/nose crop line) down to the waist — never the knees, never the full body, never a wide environment shot where the person looks small. The torso fills most of the frame width, and the chest embroidery spans at least ONE QUARTER of the frame width with every stitch clearly readable. If the scene description and this rule conflict, this rule wins.
...
NEGATIVE: no fully visible face — always cropped above the lips, turned away, or hidden by cap and sunglasses; no distorted face or hands, no sleeve or collar embroidery, no extra text or logos, no watermarks, no distorted lettering, no misspelling, no plastic print or DTG look, no flat 2D graphic or sticker pasted-on look, no smooth vector fills — every color area must show real thread direction and stitch texture, no fuzzy or pilled fabric, no flat uniform fabric color, no studio lighting, no oversaturated colors, no oversized design — the embroidery never spans more than one third of the chest width, no wide shot, no full-body shot, no distant camera, the embroidery never smaller than a quarter of the frame width.
